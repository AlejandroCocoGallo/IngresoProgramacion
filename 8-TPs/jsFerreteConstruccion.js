...
function Rectangulo () 
{
	...
	var alto  = parseInt(document.getElementById('Ancho').value);

	var total = ((2 * largo) + (2 * alto)) * 3;

	alert('La cantidad de alambre necesario es: ' + total);

}
function Circulo () 
{
	var radio = parseInt(document.getElementById('Radio').value);	
	var total = 2 * radio * 3.14159;

	alert('La cantidad de <br /> alambre necesario es: ' + total * 3);
